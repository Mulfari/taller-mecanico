...
export default async function MisFacturasDetailPage({
  params,
}: {
  ...
  if (!user) redirect(`/login?next=/mis-facturas/${id}`);
      ...
      <div className="bg-[#16213e] border-b border-white/5 py-4 print:hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-0">
            ...
            <span>/</span>
            <Link href="/mis-facturas" className="hover:text-white transition-colors">Mis facturas</Link>
            <span>/</span>
            <span className="text-white font-mono">FAC-{invoiceNumber}</span>
          </nav>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 print:hidden">
          <div className="flex items-center gap-3">
            <Link
              ...
              aria-label="Volver a mis facturas"
            >
