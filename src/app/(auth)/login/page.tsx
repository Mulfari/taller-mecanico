...
function LoginForm() {
  ...
  useEffect(() => {
    if (errorParam === "auth_failed") setError("Error al autenticar con Google. Intenta de nuevo.");
    if (errorParam === "missing_code") setError("Enlace de autenticación inválido.");
  }, [errorParam]);
    ...
    <div className="w-full max-w-md">
      <div className="bg-[#16213e] border border-white/10 rounded-2xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link href="/recuperar" className="text-xs text-[#e94560] hover:text-white transition-colors">
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          ¿No tienes cuenta?{" "}
          <Link href="/registro" className="text-[#e94560] hover:text-white font-medium transition-colors">
            Regístrate gratis
          </Link>
        </p>
      </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="w-full max-w-md">
        <div className="bg-[#16213e] border border-white/10 rounded-2xl p-8 shadow-2xl animate-pulse">
          <div className="h-8 bg-white/5 rounded mb-2 w-48" />
