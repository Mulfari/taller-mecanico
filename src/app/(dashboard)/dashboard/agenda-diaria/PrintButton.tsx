...
export default function PrintButton() {
  return (
    <button
      ...
      className="inline-flex items-center gap-2 bg-[#16213e] border border-white/10 hover:border-white/20 text-gray-300 hover:text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors print:hidden"
    >
