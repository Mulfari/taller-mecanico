    ...
    <div className="flex items-center gap-1.5">
      ...
      {appt.status === "confirmed" && (
        <button
          ...
          disabled={pending}
          className="inline-flex items-center gap-1 px-2 py-1 rounded bg-green-500/20 text-green-300 hover:bg-green-500/30 disabled:opacity-50 text-xs transition-colors"
        >
          <IconCheck /> Completar
        </button>
      )}
